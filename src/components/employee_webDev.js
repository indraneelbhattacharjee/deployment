...
export const EmployeeWebDevServicePage = () => {
  ...
  const goToPayment = () => {
    navigate(`/employee_payment?name=${encodeURIComponent(webDevService.name)}&price=${webDevService.price}`);
  };
...
export default EmployeeWebDevServicePage;