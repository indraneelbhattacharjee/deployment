    ...
    style={{ 
      ...
      <div className="flex-grow p-8 text-gray-800">
        <div className="max-w-4xl mx-auto text-white shadow-md rounded-lg p-6 space-y-6">
          ...
          <p className="pl-36">
            At Bay Develops, we offer a comprehensive range of web development services...
          </p>
          ...
          <h1 className="text-3xl font-semibold pl-36">Why Choose Us for Your Web Development Needs?</h1>
          <p className="pl-36">
          ...
          <h5 className="text-3xl font-semibold pl-36">If you are looking for a reliable and experienced web development company, contact us today.
              We will be happy to discuss your needs and help you create a website that will help you achieve
              your business objectives.</h5>
